        ...
        <animated.div style={props}>
          <div id="top" className={styles.wrapper + " " + "main"}>
                ...
                <div className={styles.textContainerSubContainer}>
                  ...
                  <div className={styles.textContainer}>
                    ...
                    >
                      ...
                      cómo es nuestro equipo. Nos gusta trabajar con el
                    ...
                    >
                      ...
                      <span>
                        ...
                        <span style={{ color: "#0885e6" }}>
                          ...
                          tendencias, para brindar las respuestas más eficientes
                          y eficaces para su empresa
                        </span>
                      </span>
                    </p>
                ...
                <div className={styles.textContainerSubContainer}>
                  ...
                  <div className={styles.textContainer}>
                    <p className={styles.description}>
                      ...
                      del mercado ya que ningún es un servicio integral, sino
                      que todos son tratados como problemas separados.
                      <span style={{ color: "#0885e6" }}>
                        {" "}
            ...
            <BoxUserName
              ...
              boxUserName
              name={sessionStorage.getItem("name") || userName}
            />
