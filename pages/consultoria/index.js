                                ...
                                <section className={styles.main}>
                                    ...
                                    <div className={styles.contentContainer}>
                                        ...
                                        <p className={styles.description}>
                                            ...
                                            sistemas, llevando un registro del equipamiento
                                            colocando especial atención a la performance, la
                                            reducción de riesgos y los tiempos de respuesta.
                                        </p>
                                        <p className={styles.description}>
                                            Definimos y gestionamos un plan de actualizaciones en
                                            base a tecnologías y metodologías ágiles.
                                        </p>
