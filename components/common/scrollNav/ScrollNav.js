        ...
        <div className={styles.scrollNav}>
            ...
            <div className={styles.dots}>
                <Link href="/#firstSection" passHref>
                    <div id="link1" className={showNavDot().isVisible1 && styles.dot}></div>
                </Link>
                <Link href="/#servicios" passHref>
                    <div id="link2" className={showNavDot().isVisible2 && styles.dot}></div>
                </Link>
                <Link href="/#thirdSection" passHref>
                    <div id="link3" className={showNavDot().isVisible3 && styles.dot}></div>
                </Link>
            </div>
