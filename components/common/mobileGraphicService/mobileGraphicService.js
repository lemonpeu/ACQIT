                    ...
                    <div className={styles.firstSection}>
                        ...
                        <div className={styles.servicesItemContainer}>
                            ...
                            <div className={styles.descriptionContainer}>
                                ...
                                <p className={styles.graphDescription}>
                                    Nuestro equipo se encarga de gestionar, administrar y optimizar
                                    tus sistemas y procesos enfocándonos en obtener los mejores
                                    resultados.
                                </p>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className={styles.servicesItemContainer}>
                            ...
                            <div className={styles.descriptionContainer}>
                                ...
                                <p className={styles.graphDescription}>
                                    Protegemos tu organización y tus datos de cualquier ciberataque
                                    haciendo uso de herramientas de control de primer nivel.
                                </p>
                            </div>
                        </div>
                    </div>
