...
const LinesHomeSection = ({ is3rdSectionVisible, isFooterMobile, ref, isVisible }) => {
    ...
    return (
        <div className={styles.linesHomeSection + ' ' + 'section'} id="linesGraphic">
            <section className={styles.linesGraphicContainer} id="thirdSection" ref={setRef}>
